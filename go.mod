...
// Pin knative.dev/pkg to version that still has metrics/tracing packages needed by knative.dev/eventing
replace (
	github.com/tektoncd/pipeline => github.com/khrm/pipeline v0.0.0-20260209081910-ae12efaa8443
	knative.dev/pkg => knative.dev/pkg v0.0.0-20250909011231-077dcf0d00e8
)
