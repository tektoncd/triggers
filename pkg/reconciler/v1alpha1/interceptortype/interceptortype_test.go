...
func TestReconcileKind(t *testing.T) {
	tests := []struct {
		name    string
		initial *triggersv1.InterceptorType // State of the world before we call Reconcile
		want    *triggersv1.InterceptorType // Expected State of the world after calling Reconcile
	}{{
		name: "inital status is nil",
		initial: &triggersv1.InterceptorType{
