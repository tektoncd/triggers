...
import (
	...
	interceptorreconciler "github.com/tektoncd/triggers/pkg/client/injection/reconciler/triggers/v1alpha1/namespacedinterceptor"
	v1 "knative.dev/pkg/apis/duck/v1"
	"knative.dev/pkg/logging"
	pkgreconciler "knative.dev/pkg/reconciler"
)

const ControllerName = "NamespacedInterceptor"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, it *v1alpha1.NamespacedInterceptor) pkgreconciler.Event {
