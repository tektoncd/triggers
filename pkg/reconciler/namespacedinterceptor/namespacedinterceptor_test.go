...
func TestReconcileKind(t *testing.T) {
	tests := []struct {
		name    string
		initial *triggersv1.NamespacedInterceptor // State of the world before we call Reconcile
		want    *triggersv1.NamespacedInterceptor // Expected State of the world after calling Reconcile
	}{{
		name: "initial status is nil",
		initial: &triggersv1.NamespacedInterceptor{
			...
			Status: triggersv1.NamespacedInterceptorStatus{},
		},
		want: &triggersv1.NamespacedInterceptor{
			ObjectMeta: metav1.ObjectMeta{
				Name: "my-interceptor",
			},
			Spec: triggersv1.NamespacedInterceptorSpec{
