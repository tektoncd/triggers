...
func (s *ScheduledTemplateSpec) validate(ctx context.Context) (errs *apis.FieldError) {
	...
	errs = errs.Also(validateScheduledResourceTemplates(s.ResourceTemplates).ViaField("resourcetemplates"))
	errs = errs.Also(verifyScheduledResourceParamDeclarations(s.Params, s.ResourceTemplates).ViaField("resourcetemplates"))
	return errs
}

func validateScheduledResourceTemplates(templates []ScheduledResourceTemplate) (errs *apis.FieldError) {
...
func verifyScheduledResourceParamDeclarations(params []ParamSpec, templates []ScheduledResourceTemplate) *apis.FieldError {
