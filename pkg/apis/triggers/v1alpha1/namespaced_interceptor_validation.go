...
// Validate NamespacedInterceptor
func (it *NamespacedInterceptor) Validate(ctx context.Context) *apis.FieldError {
...
func (s *NamespacedInterceptorSpec) validate(ctx context.Context) (errs *apis.FieldError) {
