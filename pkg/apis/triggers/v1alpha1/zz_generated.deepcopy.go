...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerRefSpec) DeepCopyInto(out *TriggerRefSpec) {
	*out = *in
	if in.Ref != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerRefSpec.
func (in *TriggerRefSpec) DeepCopy() *TriggerRefSpec {
	if in == nil {
		return nil
	}
	out := new(TriggerRefSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TriggerSpec) DeepCopyInto(out *TriggerSpec) {
	*out = *in
	...
	if in.Triggers != nil {
		in, out := &in.Triggers, &out.Triggers
		*out = make([]*TriggerRefSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(TriggerRefSpec)
