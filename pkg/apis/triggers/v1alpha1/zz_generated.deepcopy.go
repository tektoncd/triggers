...
func (in *TriggerBindingSpec) DeepCopyInto(out *TriggerBindingSpec) {
	*out = *in
	if in.TemplateBindings != nil {
		in, out := &in.TemplateBindings, &out.TemplateBindings
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerTemplateEvent) DeepCopyInto(out *TriggerTemplateEvent) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerTemplateEvent.
func (in *TriggerTemplateEvent) DeepCopy() *TriggerTemplateEvent {
	if in == nil {
		return nil
	}
	out := new(TriggerTemplateEvent)
	in.DeepCopyInto(out)
	return out
}
