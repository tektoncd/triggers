...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InternalInterceptor) DeepCopyInto(out *InternalInterceptor) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InternalInterceptor.
func (in *InternalInterceptor) DeepCopy() *InternalInterceptor {
	if in == nil {
		return nil
	}
	out := new(InternalInterceptor)
	in.DeepCopyInto(out)
	return out
}
