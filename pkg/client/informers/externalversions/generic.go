...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("namespacedinterceptors"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Triggers().V1alpha1().NamespacedInterceptors().Informer()}, nil
