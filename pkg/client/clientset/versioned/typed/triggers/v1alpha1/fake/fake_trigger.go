...
var triggersResource = schema.GroupVersionResource{Group: "tekton.dev", Version: "v1alpha1", Resource: "triggers"}

var triggersKind = schema.GroupVersionKind{Group: "tekton.dev", Version: "v1alpha1", Kind: "Trigger"}
