...
var triggertemplatesResource = v1alpha1.SchemeGroupVersion.WithResource("triggertemplates")

var triggertemplatesKind = v1alpha1.SchemeGroupVersion.WithKind("TriggerTemplate")
