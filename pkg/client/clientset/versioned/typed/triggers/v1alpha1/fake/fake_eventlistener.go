...
func (c *FakeEventListeners) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventListener, err error) {
	emptyResult := &v1alpha1.EventListener{}
	obj, err := c.Fake.
...
func (c *FakeEventListeners) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventListenerList, err error) {
	emptyResult := &v1alpha1.EventListenerList{}
	obj, err := c.Fake.
...
func (c *FakeEventListeners) UpdateStatus(ctx context.Context, eventListener *v1alpha1.EventListener, opts v1.UpdateOptions) (result *v1alpha1.EventListener, err error) {
	emptyResult := &v1alpha1.EventListener{}
	obj, err := c.Fake.
