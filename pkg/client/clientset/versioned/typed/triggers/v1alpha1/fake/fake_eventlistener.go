...
var eventlistenersResource = schema.GroupVersionResource{Group: "triggers", Version: "v1alpha1", Resource: "eventlisteners"}

var eventlistenersKind = schema.GroupVersionKind{Group: "triggers", Version: "v1alpha1", Kind: "EventListener"}
