...
type ClusterTriggerBindingInterface interface {
	Create(*v1alpha1.ClusterTriggerBinding) (*v1alpha1.ClusterTriggerBinding, error)
	Update(*v1alpha1.ClusterTriggerBinding) (*v1alpha1.ClusterTriggerBinding, error)
	UpdateStatus(*v1alpha1.ClusterTriggerBinding) (*v1alpha1.ClusterTriggerBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ClusterTriggerBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.ClusterTriggerBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterTriggerBinding, err error)
...
func (c *clusterTriggerBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterTriggerBinding, err error) {
...
func (c *clusterTriggerBindings) List(opts v1.ListOptions) (result *v1alpha1.ClusterTriggerBindingList, err error) {
...
func (c *clusterTriggerBindings) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterTriggerBindings) Create(clusterTriggerBinding *v1alpha1.ClusterTriggerBinding) (result *v1alpha1.ClusterTriggerBinding, err error) {
	result = &v1alpha1.ClusterTriggerBinding{}
	err = c.client.Post().
		Resource("clustertriggerbindings").
...
func (c *clusterTriggerBindings) Update(clusterTriggerBinding *v1alpha1.ClusterTriggerBinding) (result *v1alpha1.ClusterTriggerBinding, err error) {
	result = &v1alpha1.ClusterTriggerBinding{}
	err = c.client.Put().
		Resource("clustertriggerbindings").
...
func (c *clusterTriggerBindings) UpdateStatus(clusterTriggerBinding *v1alpha1.ClusterTriggerBinding) (result *v1alpha1.ClusterTriggerBinding, err error) {
	result = &v1alpha1.ClusterTriggerBinding{}
	err = c.client.Put().
		Resource("clustertriggerbindings").
		Name(clusterTriggerBinding.Name).
...
func (c *clusterTriggerBindings) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *clusterTriggerBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterTriggerBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterTriggerBinding, err error) {
	result = &v1alpha1.ClusterTriggerBinding{}
