...
var eventlistenersResource = v1beta1.SchemeGroupVersion.WithResource("eventlisteners")

var eventlistenersKind = v1beta1.SchemeGroupVersion.WithKind("EventListener")
