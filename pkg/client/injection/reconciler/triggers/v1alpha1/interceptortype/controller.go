...
const (
	defaultControllerAgentName = "interceptortype-controller"
	defaultFinalizerName       = "interceptortypes.triggers.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	interceptortypeInformer := interceptortype.Get(ctx)

	lister := interceptortypeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "triggers.tekton.dev.InterceptorType"),
	)
