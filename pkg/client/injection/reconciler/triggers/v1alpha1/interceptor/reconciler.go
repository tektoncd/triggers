...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Interceptor, desired *v1alpha1.Interceptor) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Interceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.Interceptor, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.Interceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.Interceptor, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.Interceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.Interceptor, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.Interceptor, reconcileEvent reconciler.Event) (*v1alpha1.Interceptor, error) {
	...
	if err != nil {
		...
		getter := r.Client.TriggersV1alpha1().Interceptors(resource.Namespace)
