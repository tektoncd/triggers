...
import (
	...
	namespacedinterceptor "github.com/tektoncd/triggers/pkg/client/injection/informers/triggers/v1alpha1/namespacedinterceptor"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "namespacedinterceptor-controller"
	defaultFinalizerName       = "namespacedinterceptors.triggers.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	namespacedinterceptorInformer := namespacedinterceptor.Get(ctx)

	lister := namespacedinterceptorInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "triggers.tekton.dev.NamespacedInterceptor"),
	)
