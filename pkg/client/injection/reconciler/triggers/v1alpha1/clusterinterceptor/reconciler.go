...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterInterceptor, desiredFinalizers sets.String) (*v1alpha1.ClusterInterceptor, error) {
	// Don't modify the informers copy.
