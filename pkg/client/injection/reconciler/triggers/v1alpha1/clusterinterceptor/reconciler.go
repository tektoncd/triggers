...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister triggersv1alpha1.ClusterInterceptorLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.ClusterInterceptor, desired *v1alpha1.ClusterInterceptor) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterInterceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.ClusterInterceptor, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.ClusterInterceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.ClusterInterceptor, error) {
	...
	patcher := r.Client.TriggersV1alpha1().ClusterInterceptors()
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.ClusterInterceptor, desiredFinalizers sets.Set[string]) (*v1alpha1.ClusterInterceptor, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.ClusterInterceptor) (*v1alpha1.ClusterInterceptor, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.ClusterInterceptor, reconcileEvent reconciler.Event) (*v1alpha1.ClusterInterceptor, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
