...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventListener, desiredFinalizers sets.String) (*v1alpha1.EventListener, error) {
	// Don't modify the informers copy.
