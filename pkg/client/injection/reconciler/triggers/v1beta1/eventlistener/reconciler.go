...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister triggersv1beta1.EventListenerLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.EventListener, desired *v1beta1.EventListener) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.EventListener, desiredFinalizers sets.Set[string]) (*v1beta1.EventListener, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.EventListener, desiredFinalizers sets.Set[string]) (*v1beta1.EventListener, error) {
	...
	patcher := r.Client.TriggersV1beta1().EventListeners(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.EventListener, desiredFinalizers sets.Set[string]) (*v1beta1.EventListener, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.EventListener) (*v1beta1.EventListener, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.EventListener, reconcileEvent reconciler.Event) (*v1beta1.EventListener, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
	...
	if err != nil {
		...
		getter := r.Client.TriggersV1beta1().EventListeners(resource.Namespace)
