...
// controller finalizing v1beta1.EventListener if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1beta1.EventListener.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1beta1.EventListener) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1beta1.EventListener, desired *v1beta1.EventListener) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.EventListener) (*v1beta1.EventListener, error) {
