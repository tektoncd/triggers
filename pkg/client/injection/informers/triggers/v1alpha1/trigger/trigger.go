...
var _ triggersv1alpha1.TriggerLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apistriggersv1alpha1.Trigger{}, 0, nil)
}

func (w *wrapper) Lister() triggersv1alpha1.TriggerLister {
	return w
}

func (w *wrapper) Triggers(namespace string) triggersv1alpha1.TriggerNamespaceLister {
...
func (w *wrapper) List(selector labels.Selector) (ret []*apistriggersv1alpha1.Trigger, err error) {
	lo, err := w.client.TriggersV1alpha1().Triggers(w.namespace).List(context.TODO(), v1.ListOptions{
...
func (w *wrapper) Get(name string) (*apistriggersv1alpha1.Trigger, error) {
	return w.client.TriggersV1alpha1().Triggers(w.namespace).Get(context.TODO(), name, v1.GetOptions{
		ResourceVersion: w.resourceVersion,
	})
}
