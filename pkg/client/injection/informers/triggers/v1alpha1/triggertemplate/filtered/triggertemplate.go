...
func Get(ctx context.Context, selector string) v1alpha1.TriggerTemplateInformer {
...
var _ v1alpha1.TriggerTemplateInformer = (*wrapper)(nil)
var _ triggersv1alpha1.TriggerTemplateLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apistriggersv1alpha1.TriggerTemplate{}, 0, nil)
}

func (w *wrapper) Lister() triggersv1alpha1.TriggerTemplateLister {
	return w
}

func (w *wrapper) TriggerTemplates(namespace string) triggersv1alpha1.TriggerTemplateNamespaceLister {
	return &wrapper{client: w.client, namespace: namespace, selector: w.selector}
}

func (w *wrapper) List(selector labels.Selector) (ret []*apistriggersv1alpha1.TriggerTemplate, err error) {
	reqs, err := labels.ParseToRequirements(w.selector)
	if err != nil {
		return nil, err
	}
	selector = selector.Add(reqs...)
	lo, err := w.client.TriggersV1alpha1().TriggerTemplates(w.namespace).List(context.TODO(), v1.ListOptions{
...
func (w *wrapper) Get(name string) (*apistriggersv1alpha1.TriggerTemplate, error) {
	// TODO(mattmoor): Check that the fetched object matches the selector.
	return w.client.TriggersV1alpha1().TriggerTemplates(w.namespace).Get(context.TODO(), name, v1.GetOptions{
		// TODO(mattmoor): Incorporate resourceVersion bounds based on staleness criteria.
	})
}
