...
func TestInterceptor_ExecuteTrigger_owners(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			allowed: false,
			wantErr: true,
			want:    "enableOrgMemberCheck or enableRepoMemberCheck is enabled but no personalAccessToken was supplied",
		},
		{
