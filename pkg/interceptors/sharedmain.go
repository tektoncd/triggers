...
func InterceptorMainWithConfig(ctx context.Context, component string, interceptors map[string]v1alpha1.InterceptorInterface) {
	...
	service, err := NewWithInterceptors(ctx, kubeClient, logger, interceptors)
	if err != nil {
