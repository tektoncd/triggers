...
func runInteractiveSetup() error {
	...
	if githubRepo != "" && publicDomain != "" && githubToken != "" {
		fmt.Println("GitHub configuration already there")
		return nil
	}
	...
	if githubRepo == "" {
		...
		if githubRepo == "" {
			fmt.Println("Skipping GitHub integration.")
			return nil
		}
	}
	...
	if publicDomain == "" {
		...
		if publicDomain == "" {
			fmt.Println("Skipping GitHub integration - public domain required.")
			return nil
		}
	}
	...
	if githubToken == "" {
		...
		if githubToken == "" {
			fmt.Println("Skipping GitHub integration - token required for webhook creation.")
			return nil
		}
	}
	return nil
