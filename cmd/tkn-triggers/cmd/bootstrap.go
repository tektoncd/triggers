...
func bootstrapRun(cmd *cobra.Command, args []string) error {
	...
	// tmp config just for installation checks
	...
	log.Println("== Checking Tekton Pipelines...")
	...
	log.Println("== Checking Tekton Triggers...")
	...
	log.Println("== Setting up Tekton Triggers resources...")
	...
	log.Println("Tekton Triggers setup complete!")
