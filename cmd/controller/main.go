...
var (
	...
	maxBodySize               = flag.Int64("el-max-body-size", elresources.DefaultMaxBodySize, "The maximum accepted request body size, in bytes, for EventListener Server. Zero or less disables the limit.")
